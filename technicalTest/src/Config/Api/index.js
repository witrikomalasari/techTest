// export let ListHargaUdang =
//   'https://app.jala.tech/api/shrimp_prices?per_page=15&page=1&with=region,creator&region_id=';

// export let FilterHargaUdang =
//   'https://app.jala.tech/api/regions?has=shrimp_prices&search=';

// export let DetailHargaUdang =
//   'https://app.jala.tech/api/shrimp_prices/(id)?with=region,creator&region_id=';

// let ListKabarUdang =
//   'https://app.jala.tech/api/posts?per_page=15&page=1&with=creator';

// let ListPenyakit = 'https://app.jala.tech/api/diseases?per_page=15&page=1';
